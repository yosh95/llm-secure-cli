...
pub type ToolFunc = fn(HashMap<String, Value>) -> anyhow::Result<Value>;
...
fn register_builtin_tools(r: &mut ToolRegistry) {
    r.register(
        ...
        crate::modules::tools::file_ops::list_files_in_directory,
    );
    ...
    r.register(
        ...
        crate::modules::tools::file_ops::read_file_content,
    );
    ...
    r.register(
        ...
        crate::modules::tools::file_ops::grep_files,
    );
    ...
    r.register(
        ...
        crate::modules::tools::file_ops::search_files,
    );
    ...
    r.register(
        ...
        crate::modules::tools::file_modification::edit_file,
    );
    ...
    r.register(
        ...
        crate::modules::tools::file_modification::create_or_overwrite_file
    );
    ...
    r.register(
        ...
        crate::modules::tools::web::read_url_content,
    );

    // Brave Search: register only if API key is available
    let brave_key = crate::clients::config::CONFIG_MANAGER.get_api_key("brave");
    if brave_key.is_some() {
        r.register(
            ...
            crate::modules::tools::web::brave_search,
        );
    }
    ...
    r.register(
        ...
        crate::modules::tools::shell::execute_command,
    );
}
