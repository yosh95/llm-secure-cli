use crate::clients::tool_executor_types::ToolExecutionContext;
use crate::consts::{MAX_OUTPUT_CHARS, MAX_OUTPUT_LINES};
use crate::modules::models::{ContentPart, MessagePart};
...
pub fn print_tool_output(res_str: &str) {
    crate::ui::print_block(res_str, Some("[OK] Tool Output"), Some("green"));
}
